...
4. After programming, the CE starts automatically. It enter the sleep mode. Confirm that the messages are displayed on the UART terminal, and confirm that the User LED2 and User LED3 are blinking.
...
- **Sleep mode setting**
  ...
  - Calling <a href="https://infineon.github.io/mtb-pdl-cat1/pdl_api_reference_manual/html/group__group__syspm__functions__power.html#gab09936e85606de476a0c379f9548603f"><i>Cy_SysPm_CpuEnterSleep()</i></a> function to enter the sleep mode
...
**Table 2.  Available LED**
   
   Board                |  User LED2    |  User LED3   
   :-------             | :------------ | :------------       
